  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-y-0 right-0 max-w-full flex pl-10">
        ...
        >
          {/* Sticky Header */}
          <div className="sticky top-0 bg-white z-10 px-6 py-5 border-b border-neutral-200/80 flex items-center justify-between gap-4">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                ...
                {subtitle && (
                  <h3
                    id="drawer-title"
                    className="text-lg font-extrabold text-neutral-900 truncate font-urbanist mt-0.5"
                  >
                    {subtitle}
                  </h3>
                )}
            ...
            <button
              ...
              className="p-2 rounded-xl text-neutral-400 hover:text-neutral-700 hover:bg-neutral-100 transition-all shrink-0"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
          ...
          {/* Sticky Footer */}
          {footerActions && (
            <div className="sticky bottom-0 bg-neutral-50/90 backdrop-blur-xs z-10 px-6 py-4 border-t border-neutral-200/80 flex items-center justify-between gap-3">
              {footerActions}
            </div>
          )}
        </div>
