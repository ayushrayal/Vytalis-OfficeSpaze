...
const VirtualOfficesHeader = ({ onAddClick, onRefresh, isFetching }) => {
  return (
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <p className="text-sm font-medium text-muted-text mt-1">
            Manage virtual office clients, commercial agreements, and allocations.
          </p>
        </div>
      </div>
...
export default VirtualOfficesHeader;
