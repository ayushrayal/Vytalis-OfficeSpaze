...
const AggregatorsHeader = ({ onAddClick, onRefresh, isFetching }) => {
  return (
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <p className="text-sm font-medium text-muted-text mt-1">
            Manage partner aggregators and track Virtual Office acquisitions.
          </p>
        </div>
      </div>
...
export default AggregatorsHeader;
