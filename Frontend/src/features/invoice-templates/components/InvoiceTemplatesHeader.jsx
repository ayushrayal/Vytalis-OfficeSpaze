...
const InvoiceTemplatesHeader = ({ onAddClick, onRefresh, isFetching = false }) => {
  return (
    <div className="header-container flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 font-urbanist">
      <div>
        <h1 className="text-2xl md:text-3xl font-bold text-[#000000] tracking-tight font-urbanist">
          Invoice Templates
        </h1>
        <p className="text-[#505050] text-sm mt-1">
          Create, manage and generate professional invoices.
        </p>
      </div>
...
export default InvoiceTemplatesHeader;
