...
const CoworkSpaceEmptyState = ({ isFiltered = false, onClearFilters, onAddClick }) => {
  if (isFiltered) {
    return (
      <div className="bg-white border border-[#E5E5E5] rounded-xl p-12 text-center shadow-sm font-urbanist my-6">
        ...
        <h3 className="text-base font-bold text-[#000000] mb-1">
          No matching cowork space records
        </h3>
        <p className="text-xs text-[#505050] max-w-sm mx-auto mb-4">
          We couldn't find any cowork space records matching your search or filter criteria.
        </p>
        <button
          type="button"
  ...
  return (
    <div className="bg-white border border-[#E5E5E5] rounded-xl p-12 text-center shadow-sm font-urbanist my-6">
      ...
      <h3 className="text-lg font-bold text-[#000000] mb-1">
        No cowork space records yet
      </h3>
      <p className="text-xs text-[#505050] max-w-sm mx-auto mb-4">
        Add your first cowork space record to start managing clients and seat allocations.
      </p>
      {onAddClick && (
        <button
          type="button"
...
export default CoworkSpaceEmptyState;
