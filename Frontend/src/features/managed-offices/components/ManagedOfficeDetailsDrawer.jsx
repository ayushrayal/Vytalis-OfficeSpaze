...
import { Building, Edit2, Trash2, User, MapPin, Calendar, DollarSign, FileText, Clock, Armchair } from 'lucide-react';
import DetailsDrawer from '../../../components/common/DetailsDrawer';
import { DetailSection, DetailRow, DetailBadge } from '../../../components/common/DetailDrawerPrimitives';
import { formatDateDisplay, calculateStatus } from '../utils/managedOffices.utils';
import { format } from 'date-fns';

const ManagedOfficeDetailsDrawer = ({ isOpen, onClose, office, onEdit, onDelete, onViewAgreement }) => {
...
export default ManagedOfficeDetailsDrawer;
