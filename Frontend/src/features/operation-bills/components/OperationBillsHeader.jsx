...
const OperationBillsHeader = ({ onAddClick, onRefresh, isFetching = false }) => {
  return (
    <div className="header-container flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
      <div>
        ...
        <p className="text-[#505050] text-sm mt-1">
          Manage and track office operational expenses and payment status.
        </p>
      </div>
...
export default OperationBillsHeader;
