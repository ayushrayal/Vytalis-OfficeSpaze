...
import { calculateSummaryMetrics } from '../utils/dedicatedSpace.utils';

const DedicatedSpaceSummaryStrip = ({ spaces = [] }) => {
...
export default DedicatedSpaceSummaryStrip;
